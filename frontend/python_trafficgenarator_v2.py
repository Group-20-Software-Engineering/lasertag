...
send_udp_packet("Hardware/" + red1 + "/" + red1)
send_udp_packet("Hardware/" + red2 + "/" + red2)
redPlayers.append(red1)
redPlayers.append(red2)
send_udp_packet("Hardware/" + green1 + "/" + green1)
send_udp_packet("Hardware/" + green2 + "/" + green2)
greenPlayers.append(green1)
greenPlayers.append(green2)
jsonObject = json.dumps(redPlayers)
with open("redPlayers.json", "w") as outfile:
                    outfile.write(jsonObject)
jsonObject = json.dumps(greenPlayers)
