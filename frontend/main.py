...
def rocketAndText(screen, title, defFont, coolFont, y):
    ...
    #Extra Story Ignore for Now
    #storyText = "\n\n    In a world where there 2 factions\n\n      The Gooners and the Never Gooners\n      There war has raged for centuries\n     Millions have fallen\n\n defending what they belive to be right\n    The Gooners, with their red armor\n\n   The Never Gooners, with their green armor\n\n      You are the last hope for your faction\n  You must fight to the death\n\n to defend your honor\n\n to defend your family\n\n  here you make your final stand"
